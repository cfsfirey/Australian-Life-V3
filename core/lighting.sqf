RPP_fnc_activateLights = {
	...
	_typeOfLights = ["MAP_lampa_sidl", "MAP_lampa_sidl_2", "MAP_lampa_ind", "lampa_ind", "lamp_street2_ep1", "lamp_small_ep1", "lamp_street1_ep1", "lampa_sidl_2", "StreetLamp_EP1", "MAP_lampa_sidl_3", "Land_Lamp_Small_EP1"];
