...
[
	...
	/* Classic Cars */
	[shop_monaco, "monaco", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_roadrunner2, "roadrunner2", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_barcuda, "barcuda", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_fury, "fury", "", [0,0], [] call RPP_fnc_generateID, 0, true, true],
    [shop_challenger, "challenger", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_civic, "civic", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_roadrunner, "roadrunner", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
    [shop_cuda, "cuda", "", [0,0], [] call RPP_fnc_generateID, 1, true, true],
	//[shop_car_m5, "rpp_m5", "", [0, 0], [] call RPP_fnc_generateID, 1, true, false],
	
		/* Easten Airpot */
	[shop_air_usec_bell206_2, "usec_bell206_2", "", [0,0], [] call RPP_fnc_generateID, 1, true, false],
    [shop_air_qantas_C130, "qantas_C130", "", [0,0], [] call RPP_fnc_generateID, 1, true, false],
	[shop_air_usec_bell206_1, "usec_bell206_1", "", [0,0], [] call RPP_fnc_generateID, 1, true, false],
	[shop_air_GNT_C185F, "GNT_C185F", "", [0,0], [] call RPP_fnc_generateID, 1, true, false],
	...
	[shop2_usec_bell206_uscg, "usec_bell206_uscg", "", [0,0], [] call RPP_fnc_generateID, 1, false, true],
    	
	/* Police Car Shop */
	[shop_Copcar, "Copcar", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
    [shop_CopcarHW1, "Copcarhw", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
    [shop_CopcarHW2, "CopcarHW2", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_swat_suv, "SUV_TK_CIV_EP1", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_cop_qin_black, "qin_evoix_black", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_cop_monaro_black, "Civcarsl", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_policefalcon, "Fordpatrolbasic", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon, "FordUC", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon_1, "FordUCBlack", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon_2, "FordUCBlue", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon_3, "FordUCGreen", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon_4, "FordUCRed", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	[shop_ucfalcon_5, "FordUCSilver", "", [0,0], [] call RPP_fnc_generateID, 99, false, true],
	...
	/* Police Item Shop */
	[shop_police_cherry, "Cherrylight", "", [0, 0], [] call RPP_fnc_generateID, 250, false, true],	
    ...
    [shop_police_radio, "ItemRadio", "", [0, 0], [] call RPP_fnc_generateID, 250, false, true],
